...
<div data-role="page">
    ...
    <div data-role="content">
		<form action="<?php echo $r->createLinkArgList('../start') ?>" method="post" data-ajax="false" data-role="collapsible-group">
			...
			<fieldset data-role="collapsible" data-collapsed="false" data-theme="b">
				...
				<ul data-role="listview">
					<li data-role="fieldcontain">
						...
						<?php if($servers): ?>
							<option value="managed" <?php echo $spectate->method == 'managed' ? 'selected="selected"' : '' ?>>
								<?php echo _('Choose a managed server') ?>
							</option>
						<?php endif; ?>
							<option value="login" <?php echo $spectate->method == 'login' ? 'selected="selected"' : '' ?>>
								<?php echo _('Join by login') ?>
							</option>
							<option value="ip" <?php echo $spectate->method == 'ip' ? 'selected="selected"' : '' ?>>
				...
				<ul data-role="listview" data-inset="true">
					...
					<li data-role="fieldcontain">
						<label for="spectateLoginPassword">
							<strong><?php echo _('Password (optional)') ?></strong><br/>
