					...
					<li data-role="fieldcontain">
						<div class="ui-grid-c">
							<div class="ui-block-a">
								<input type="submit" name="guestlist" value="<?= _('Guestlist') ?>" data-icon="star" <?= !$playersCount
									? 'disabled="disabled"' : ''
							?>/>
							</div>
							<div class="ui-block-b">
								<input type="submit" name="kick" value="<?= _('Kick') ?>" data-icon="info" <?= !$playersCount
											? 'disabled="disabled"' : ''
							?>/>
							</div>
							<div class="ui-block-c">
								<input type="submit" name="ban" value="<?= _('Ban') ?>" data-icon="alert" <?= !$playersCount
											? 'disabled="disabled"' : ''
							?>/>
							</div>
							<div class="ui-block-d">
								<input type="submit" name="blacklist" value="<?= _('Blacklist') ?>" data-icon="delete" <?= !$playersCount
											? 'disabled="disabled"' : ''
							?>/>
							</div>
						</div>
